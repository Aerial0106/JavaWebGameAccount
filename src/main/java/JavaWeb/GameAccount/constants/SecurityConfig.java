    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http)
        ...
        return http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .anyRequest().authenticated() // Bất kỳ yêu cầu nào kháccần xác thực.
                )
                ...
                .rememberMe(rememberMe -> rememberMe
                        ...
                        .tokenValiditySeconds(24 * 60 * 60) // Thời gian nhớ đăngnhập.
                        .userDetailsService(userDetailsService())
                )
                .exceptionHandling(exceptionHandling -> exceptionHandling
                        .accessDeniedPage("/403") // Trang báo lỗi khi truy cậpkhông được phép.
                )
